      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <div className="flex flex-col items-start space-y-2 w-full">
            <label htmlFor="firstName" className="text-[#4A3B69] font-medium ml-2">Prénom</label>
            <input
              id="firstName"
          ...
          <div className="flex flex-col items-start space-y-2 w-full">
            <label htmlFor="lastName" className="text-[#4A3B69] font-medium ml-2">Nom</label>
            <input
              id="lastName"
              className="h-14 px-6 rounded-2xl bg-[#F9FAFB] border border-gray-200 w-full focus:outline-none focus:ring-2 focus:ring-[#AC96D5] focus:border-transparent transition-all"
              name="lastName"
        ...
        <div className="flex flex-col items-start space-y-2">
          <label htmlFor="senderEmail" className="text-[#4A3B69] font-medium ml-2">E-mail <span className="text-[#FFB088]">*</span></label>
          <input
            id="senderEmail"
            className="h-14 px-6 rounded-2xl bg-[#F9FAFB] border border-gray-200 w-full focus:outline-none focus:ring-2 focus:ring-[#AC96D5] focus:border-transparent transition-all"
            name="senderEmail"
        ...
        {/* Message */}
        <div className="flex flex-col items-start space-y-2">
          <label htmlFor="message" className="text-[#4A3B69] font-medium ml-2">Message <span className="text-[#FFB088]">*</span></label>
          <textarea
            id="message"
